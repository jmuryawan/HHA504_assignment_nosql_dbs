## 1 - Screenshots of the database creation and configuration process in BigQuery, MongoDB Atlas, and Redis Cloud
### **BigQuery**
...
### Make note of your connection string and database username and password to make a connection through the MongoDB Compass application
...
### **BigQuery**
super easy, simple, and straightforward to do
